 ...
 *
 * Un seul client service_role dans cette app (`createServiceClient()`, scopé au schéma
 * vida_langue pour `.from()` mais `.auth.admin.*` opère toujours sur le schéma `auth`
 * indépendamment de l'option `db.schema`) — pas besoin de 2 clients distincts.
 */
