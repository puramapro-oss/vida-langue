...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/how-it-works`, lastModified: lastMod, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${base}/ecosystem`, lastModified: lastMod, priority: 0.7, changeFrequency: 'monthly' },
    { url: `${base}/aide`, lastModified: lastMod, priority: 0.6, changeFrequency: 'weekly' },
    { url: `${base}/contact`, lastModified: lastMod, priority: 0.6, changeFrequency: 'monthly' },
    { url: `${base}/status`, lastModified: lastMod, priority: 0.5, changeFrequency: 'daily' },
    { url: `${base}/changelog`, lastModified: lastMod, priority: 0.5, changeFrequency: 'weekly' },
