...
export default function LegalAcceptanceNotice({
  ...
  return (
    <p className="text-xs text-[var(--text-muted)]">
      ...
      <a href={cguHref} className="text-[var(--cyan)] hover:underline" target="_blank" rel="noopener noreferrer">
        CGU
      </a>
      {cgvHref && (
        <>
          , nos{' '}
          <a href={cgvHref} className="text-[var(--cyan)] hover:underline" target="_blank" rel="noopener noreferrer">
            CGV
          </a>
        </>
      )}{' '}
      et notre{' '}
      <a href={confidentialiteHref} className="text-[var(--cyan)] hover:underline" target="_blank" rel="noopener noreferrer">
